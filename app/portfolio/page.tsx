...
export default function PortfolioPage() {
  ...
  const categories = ['All', 'Web Engineering', 'Product Design', 'UI Architecture', 'Branding', 'Backend Systems', 'Global SEO', 'Brand Logic', 'Cyber Dash'];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-20">
          ...
          >
            ...
            <h3 className="text-4xl md:text-8xl font-black font-orbitron tracking-normal italic text-zinc-900">
          ...
          <div className="flex flex-wrap gap-4 border-b border-zinc-100 pb-2">
            {categories.map((cat) => (
              <button
                ...
                className={`font-quantico text-[10px] uppercase tracking-widest pb-2 transition-all relative ${filter === cat ? 'text-[#a600ff]' : 'text-zinc-400 hover:text-zinc-900'
                  }`}
              >
                {cat}
                {filter === cat && (
