...
function Contact2() {
  ...
  return (
    <div className="w-full min-h-screen bg-white text-zinc-900 pt-32 pb-20 selection:bg-[#a600ff]/20">
            ...
            <div className="space-y-8 px-2">
              <div className="group flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="font-quantico text-sm font-bold text-zinc-900">wortexstudio.official@gmail.com</p>
                </div>
              </div>
              ...
              <div className="group flex items-start gap-6">
                ...
                <div>
                  ...
                  <p className="font-quantico text-sm font-bold text-zinc-900">UTC+05:00</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <form className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                <input
                  type="number"
                  className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none w-full bg-zinc-50 border border-zinc-100 px-6 py-4 rounded-2xl font-quantico text-xs focus:outline-none focus:border-[#a600ff] focus:ring-4 focus:ring-[#a600ff]/5 transition-all resize-none"
      ...
      <div className="fixed bottom-0 left-0 w-full h-[30vh] bg-linear-to-t from-zinc-50 to-transparent pointer-events-none -z-10" />
    </div>
  )
}